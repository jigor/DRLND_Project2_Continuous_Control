...
For this project, we will work with version of Reacher  Unity environment which contains 20 identical agents, each with its own copy of the environment.  
...
To solve environment agents must get an average score of +30 (over 100 consecutive episodes, and over all agents).  Specifically,
...
2. Place the file in the this repository, in the `p2_continuous-control/` folder, and unzip (or decompress) the file. 
